...
#define STRING_CONFIG_H_AUTHOR "(Gregors Dolly, 2018-03-19 )" // Who made the changes.
...
#define  DEFAULT_bedKp 201.33
#define  DEFAULT_bedKi 19.66
#define  DEFAULT_bedKd 515.39
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1600, 1600, 8080, 2480 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.7 //-2.5 // -1.6   // Z offset: -below +above  [the nozzle]
